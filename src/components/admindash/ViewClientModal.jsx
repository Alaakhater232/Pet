                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body ">
                            <div className="user-image text-center mb-3">
                                <img src={client.profileImage} alt="user-image"  style={{ borderRadius: '100%', width: '250px', height: '250px'}} />
                            </div>
                            <div className="user-details d-flex align-items-start gap-5">
                                <div className="">
                                    <p>User Name :</p>
                                    <p>Email :</p>
                                    <p>Phone :</p>
                                ...
                                <div className="">
                                    ...
                                    <p>{client.email || ''}</p>
                                    <p>{client.phone || ''}</p>
                                    <p style={{ color: 'white', backgroundColor: client.gender === 'male' ? '#007BFF ' : '#E91E63 ', fontSize: '14px' }} className='px-3 py-1 rounded rounded-5 w-50 text-center'>{client.gender || ''}</p>
                                    <p style={{ color: 'white', backgroundColor: client.role === 'customer' ? '#12101285 ' : '#007BFF ', fontSize: '14px' }} className='px-3 py-1 rounded rounded-5 w-50 text-center'>{client.role || ''}</p>
                                </div>
                            </div>
